  ...
  <TabItem label="Via CDN (UMD)">
    <Steps>
      ...
      2. Load the JavaScript library
          * Replace `<version>` with the version of the library you want to use. Get the latest version from [https://unpkg.com/@qumu/player-sdk](https://unpkg.com/@qumu/player-sdk)
